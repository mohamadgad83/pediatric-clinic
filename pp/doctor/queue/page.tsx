...
import { Clock, User, Phone, ChevronRight, RefreshCw, CheckCircle, XCircle, UserCheck } from 'lucide-react'
...
export default function QueuePage() {
    ...
    const getStatusBadge = (status: string) => {
        switch (status) {
            case 'waiting':
                return <span className="bg-yellow-100 text-yellow-700 px-3 py-1 rounded-full text-xs">في الانتظار</span>
            case 'in_clinic':
                return <span className="bg-green-100 text-green-700 px-3 py-1 rounded-full text-xs">في العيادة</span>
            case 'done':
                return <span className="bg-blue-100 text-blue-700 px-3 py-1 rounded-full text-xs">تم الكشف</span>
            case 'cancelled':
                return <span className="bg-red-100 text-red-700 px-3 py-1 rounded-full text-xs">ملغي</span>
            default:
                return null
        }
    }
