...
import { Users, Calendar, Clock, Plus, LogOut } from 'lucide-react'
...
export default function AssistantDashboard() {
    ...
    const statCards = [
        { title: 'إجمالي المرضى', value: stats.totalPatients, icon: Users, color: 'bg-purple-500' },
            ...
            <header className="bg-white shadow-sm border-b">
                <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
                    <div className="flex items-center gap-4">
                        ...
                        <span className="bg-purple-100 text-purple-700 text-xs px-3 py-1 rounded-full">مساعد</span>
                    </div>
                    <div className="flex items-center gap-4">
                        <span className="text-gray-600">{user?.user_metadata?.full_name || 'مساعد'}</span>
                        <button
            ...
            <div className="max-w-7xl mx-auto p-6">
                ...
                <div className="mb-8">
                    <h2 className="text-3xl font-bold text-gray-800">
                        مرحباً {user?.user_metadata?.full_name || 'مساعد'} 👋
                    </h2>
                    <p className="text-gray-500 mt-1">لوحة تحكم المساعد - إدارة المرضى والمواعيد</p>
                </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                    <button
                        ...
                        className="bg-blue-600 hover:bg-blue-700 text-white p-4 rounded-xl shadow-sm transition text-center"
                    >
                    ...
                    >
                        <div className="text-2xl mb-2">👶</div>
                        <p className="text-sm font-medium">قائمة المرضى</p>
                    </button>
                    <button
                        onClick={() => router.push('/assistant/queue')}
                        className="bg-white p-4 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition text-center"
                    >
                        <div className="text-2xl mb-2">📋</div>
                    ...
                    >
                        <div className="text-2xl mb-2">💳</div>
                        <p className="text-sm font-medium">الفواتير (قريباً)</p>
                    </button>
                </div>
